const Hero = () => {
    return (
        <section className="w-full px-8 py-16 bg-[#160a22]">
            <div className="min-h-[560px] max-w-7xl mx-auto">

                <div
                    className="relative min-h-[560px] overflow-hidden rounded-3xl bg-cover bg-center px-10 py-20"
                    style={{
